...
<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
  ...
  <fonts count="2">
    ...
    <cellStyles count="1"><cellStyle name="常规" xfId="0" builtinId="0"/></cellStyles><dxfs count="0"/><tableStyles count="0" defaultTableStyle="TableStyleMedium9" defaultPivotStyle="PivotStyleLight16"/></styleSheet>
})
...
(define test-styles
  (test-suite
   ...
   (test-case
    "test-styles"
    (check-equal? (write-styles '("FF0000" "00FF00" "0000FF")) (test-data1)))
   ))
